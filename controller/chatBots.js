...
module.exports.createChatBot = async (req, res) => {
    try {
      ...
      return res.status(500).json({ error: "An error occurred while creating the chatbot." });
    }
  };
...
module.exports.deleteSingleChatBot = async (req, res) => {
    try {
      ...
      return res.status(500).json({ error: "An error occurred while deleting the chatbot." });
    }
  };
